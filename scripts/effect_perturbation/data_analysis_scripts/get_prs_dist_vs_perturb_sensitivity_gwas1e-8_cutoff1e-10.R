...
## Log file / libraries --------------------------------------------------------
sink('~/Documents/GitHub/StratPRS/logs/gwas1e-8_cutoff1e-10_prs_dist_vs_perturb_sensitivity.log')
...
prs_dist <- readr::read_csv(paste0(user_defined_results_dir,
                                   'prs_dist_summaries/prs_dist_summaries_gwas',
                                   gwas.thres,
                                   '_cutoff',
                                   as.numeric(sig.cutoff),
                                   '.csv'),
...
signflip_max_prs_dist <- readr::read_csv(paste0(user_defined_results_dir,
                                                 "/prs_dist_vs_perturbation_sensitivity_raw_tables/gwas",
                                                 gwas.thres,"_cutoff",
                                                 sig.cutoff,"_signflip_max_combined.csv")) %>%
  as.data.frame()
shuffle_max_prs_dist <- readr::read_csv(paste0(user_defined_results_dir,
                                                "/prs_dist_vs_perturbation_sensitivity_raw_tables/gwas",
                                                gwas.thres,"_cutoff",
                                                sig.cutoff,"_shuffle_max_combined.csv"))%>%
  as.data.frame()
signflip_usual_prs_dist <- readr::read_csv(paste0(user_defined_results_dir,
                                                   "/prs_dist_vs_perturbation_sensitivity_raw_tables/gwas",
                                                   gwas.thres,"_cutoff",
                                                   sig.cutoff,"_signflip_usual_combined.csv"))%>%
  as.data.frame()
shuffle_usual_prs_dist <- readr::read_csv(paste0(user_defined_results_dir,
                                                  "/prs_dist_vs_perturbation_sensitivity_raw_tables/gwas",
                                                  gwas.thres,"_cutoff",
                                                  sig.cutoff,"_shuffle_usual_combined.csv"))%>%
  as.data.frame()
...
for (i in 1:nrow(shuffle_max_vs_strat_corr_array)) {
  for (j in 1:ncol(shuffle_max_vs_strat_corr_array)) {
    ...
    # Shuffle, max
    shuffle_max_res <- spearman_cor_test(shuffle_max_prs_dist[[rownames(shuffle_max_vs_strat_corr_array)[i]]],
    ...
    # Signflip, max
    signflip_max_res <- spearman_cor_test(signflip_max_prs_dist[[rownames(signflip_max_vs_strat_corr_array)[i]]],
    ...
    # Shuffle, usual
    shuffle_usual_res <- spearman_cor_test(shuffle_usual_prs_dist[[rownames(shuffle_usual_vs_strat_corr_array)[i]]],
    ...
    # Signflip, usual
    signflip_usual_res <- spearman_cor_test(signflip_usual_prs_dist[[rownames(signflip_usual_vs_strat_corr_array)[i]]],
...
readr::write_csv(shuffle_max_vs_strat_corr_array,
                 file = paste0(user_defined_results_dir,
                               "prs_dist_vs_perturbation_sensitivity_pvals_and_corrs/corr_spearman_gwas",
                               gwas.thres,"_cutoff",
                               sig.cutoff,"_shuffle_max_vs_prs_dist.csv"))
readr::write_csv(shuffle_max_vs_strat_pvals_array,
                 file = paste0(user_defined_results_dir,
                               "prs_dist_vs_perturbation_sensitivity_pvals_and_corrs/pvals_spearman_gwas",
                               gwas.thres,"_cutoff",
                               sig.cutoff,"_shuffle_max_vs_prs_dist.csv"))
